          ...
          <table className="w-full text-xs sm:text-sm min-w-[900px]" aria-label={`${label} 個人スタッツ`}>
            ...
            <thead>
              <tr className="border-b border-white/10 text-neutral-400">
                <th
                  className="text-left py-0 px-0 whitespace-nowrap sticky left-0 bg-background z-10 border-r border-white/10"
                  scope="col"
                >
            ...
            <tfoot>
              <tr className="border-t border-white/10 font-semibold">
                <td className="py-2 pl-3 pr-1.5 sm:py-3 sm:pl-4 sm:pr-2 sticky left-0 bg-background z-10 border-r border-white/10">TEAM</td>
