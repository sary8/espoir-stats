    ...
    <>
      ...
      <main id="main-content" className="pt-16">
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6">
            ...
            <motion.div initial={prefersReducedMotion ? { opacity: 1 } : { opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={prefersReducedMotion ? { duration: 0 } : { duration: 0.6 }} className="flex items-end justify-between gap-4">
              <div>
                ...
                <h1 className="font-display text-3xl sm:text-4xl md:text-5xl font-bold -mt-4 sm:-mt-6 uppercase tracking-wider">{p.name}</h1>
        ...
        <AnimatedSection className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
          <h2 className="font-display text-2xl sm:text-3xl font-bold mb-6 uppercase tracking-wider">Season Summary</h2>
        ...
        {/* Season Totals */}
        <AnimatedSection className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
          <h2 className="font-display text-2xl sm:text-3xl font-bold mb-6 uppercase tracking-wider">Season Totals</h2>
          <GlassCard>
        ...
        {games.length > 1 ? (
          <AnimatedSection className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
            <h2 className="font-display text-2xl sm:text-3xl font-bold mb-6 uppercase tracking-wider">Game-by-Game</h2>
            <GlassCard>
        ...
        {/* Game Log */}
        <AnimatedSection className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
          <h2 className="font-display text-2xl sm:text-3xl font-bold mb-6 uppercase tracking-wider">Game Log</h2>
          <GlassCard className="!p-0">
            <div className="overflow-x-auto">
              <table className="w-full text-xs sm:text-sm min-w-[900px]" aria-label={`${p.name} ゲームログ`}>
                ...
                <thead>
                  <tr className="border-b border-white/10 text-neutral-400">
                    <th className="text-left py-2 pl-3 pr-1.5 sm:py-3 sm:pl-4 sm:pr-2 whitespace-nowrap sticky left-0 bg-background z-10 border-r border-white/10" scope="col">対戦</th>
                ...
                <tbody>
                  {games.map((g) => (
                    <tr key={g.gameId} className="border-b border-white/5 hover:bg-white/5 transition-colors">
                      <td className="py-2 pl-3 pr-1.5 sm:py-3 sm:pl-4 sm:pr-2 font-medium whitespace-nowrap sticky left-0 bg-background z-10 border-r border-white/10">
                ...
                <tfoot>
                  <tr className="border-t border-white/10 font-semibold">
                    <td className="py-2 pl-3 pr-1.5 sm:py-3 sm:pl-4 sm:pr-2 sticky left-0 bg-background z-10 border-r border-white/10">TOTAL</td>
                    <td className={td}></td>
